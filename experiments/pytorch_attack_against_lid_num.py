...
from utils import acc_on_advx, get_correct_examples, load_csv, mkdir, set_seeds
...
def pytorch_attack_against_lid_num(data_name, att, epsilons, idx):
    print('Runing pytorch_attack_against_lid_num.py')
    seed = SEEDS[idx]
    set_seeds(seed)
...
if __name__ == '__main__':
    ...
    pytorch_attack_against_lid_num(data, att, epsilons, idx)
