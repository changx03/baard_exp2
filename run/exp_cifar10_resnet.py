...
def run_small_batch(att, eps, i, data='cifar10', model='resnet'):
...
if __name__ == '__main__':
    ...
    print('args:', args)
    print('Running full experiment on CIFAR10 ResNet...')

    start = time.time()
    run(args.idx)
    time_elapsed = time.time() - start
    print('Total time spend on CIFAR10 ResNet:', str(datetime.timedelta(seconds=time_elapsed)))
