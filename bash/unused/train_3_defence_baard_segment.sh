...
python3 ./experiments/train_defences.py --data segment --pretrained segment_400.pt --adv segment_basic72_boundary_0.3 --defence baard --param ./params/baard_param_3s.json --suffix 3stage
