...
NOTE: The detector will not have the Applicability Stage (Stage 1: bounding 
boxes). The main reason is that, in an easy case, e.g. MNIST, Stage 1 blocks 
all adversarial examples, so the training set for the surrogate model does not 
represent the true decision boundary of BAARD.
"""
import os
import sys
