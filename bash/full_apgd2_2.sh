...
# Step 2 Train adversarial examples: apgd2 2.0 only
...
# Step 2.9 Preprocessing training data
...
# Step 4 Train adversarial examples for training surrogate model
...
# Step 4.5 Get labels from BAARD
