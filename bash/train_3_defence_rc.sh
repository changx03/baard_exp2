...
# ./bash/train_3_defence_rc.sh | tee ./log/train_3_defence_rc.log
...
for ATT in "${ATTACKS[@]}"; do
    python3 ./experiments/train_defences_old.py --data $DATA --pretrained $DATA"_400.pt" --defence rc --param "./params/rc_param_$DATA.json" --adv $DATA"_"$MOD"_"$ATT
done
...
DATA="mnist"
for ATT in "${ATTACKS[@]}"; do
    python3 ./experiments/train_defences_old.py --data $DATA --pretrained $DATA"_200.pt" --defence rc --param "./params/rc_param_$DATA.json" --adv $DATA"_"$MOD"_"$ATT
done
...
for MOD in "${MODELS[@]}"; do
    for ATT in "${ATTACKS[@]}"; do
        python3 ./experiments/train_defences_old.py --data $DATA --pretrained $DATA"_"$MOD"_200.pt" --defence rc --param "./params/rc_param_$DATA.json" --adv $DATA"_"$MOD"_"$ATT
    done
done
