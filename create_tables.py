...
for data in all_data:
    ...
    df1 = df.pivot_table(index=['Attack', 'Epsilon','Accuracy after attack'],columns=['Defence'],values=['Score','False Positive Rate'])\
    ...
    # table 2 (without FPR)
    df2 = df.pivot_table(index=['Attack', 'Epsilon','Accuracy after attack'],columns=['Defence'],values=['Block Rate','False Positive Rate'])\
    ...
    df3 = df.pivot_table(index=['Attack', 'Epsilon','Accuracy after attack'],columns=['Defence'],values=['Score'])\
