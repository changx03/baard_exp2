...
if __name__ == '__main__':
    ...
    pytorch_attack_against_baard_img('mnist', 'dnn', 'apgd_v2_inf', [0.063, 0.3, 1.0], 0)

# python3 ./experiments/pytorch_attack_against_baard_img.py -d mnist -i 0 -a apgd -e 0.063 0.3 1.0
